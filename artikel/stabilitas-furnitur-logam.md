---
article_id: LCC-06-03
title: "Rangka, Kaki, dan Stabilitas Furnitur Logam"
slug: "stabilitas-furnitur-logam"
...
date_modified: null
parent_topic: LCC-06
primary_intent: "Menyusun kebutuhan kestabilan"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/stabilitas-furnitur-logam.html"
...
# Rangka, Kaki, dan Stabilitas Furnitur Logam

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Rangka, Kaki, dan Stabilitas Furnitur Logam”
...
- **Primary intent:** Menyusun kebutuhan kestabilan
...
- **Scope boundary:** Fokus evidence/acceptance; bukan perhitungan struktur.
- **Final public route:** `/artikel/stabilitas-furnitur-logam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Rangka, Kaki, dan Stabilitas Furnitur Logam**.
...
- `LCC-06-01` → `/artikel/spesifikasi-meja-logam.html` — Cara Menentukan Spesifikasi Meja Tembaga atau Kuningan
- `LCC-06-02` → `/artikel/top-meja-logam-solid-vs-cladding.html` — Top Meja Logam Solid, Cladding, atau Kombinasi
- `LCC-06-04` → `/artikel/detail-tepi-meja-logam.html` — Detail Tepi Meja Logam yang Nyaman dan Mudah Dirawat
...
- **Tie back to this article:** Keep the explanation specific to “Rangka, Kaki, dan Stabilitas Furnitur Logam”.
