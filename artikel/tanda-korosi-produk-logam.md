---
article_id: LCC-13-04
title: "Tanda Korosi atau Reaksi Antarmaterial pada Produk Logam"
slug: "tanda-korosi-produk-logam"
...
date_modified: null
parent_topic: LCC-13
primary_intent: "Mengenali kebutuhan investigasi"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/tanda-korosi-produk-logam.html"
...
# Tanda Korosi atau Reaksi Antarmaterial pada Produk Logam

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tanda Korosi atau Reaksi Antarmaterial pada Produk Logam”
...
- **Primary intent:** Mengenali kebutuhan investigasi
...
- **Scope boundary:** Fokus triase; bukan metode repair struktural.
- **Final public route:** `/artikel/tanda-korosi-produk-logam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tanda Korosi atau Reaksi Antarmaterial pada Produk Logam**.
...
- `LCC-13-05` → `/artikel/repair-gores-penyok-logam.html` — Gores, Penyok, dan Sambungan Rusak: Repair atau Terima?
- `LCC-13-06` → `/artikel/refinish-vs-pertahankan-patina.html` — Refinish atau Mempertahankan Patina Lama
...
- **Tie back to this article:** Keep the explanation specific to “Tanda Korosi atau Reaksi Antarmaterial pada Produk Logam”.
