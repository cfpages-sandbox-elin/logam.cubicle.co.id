---
article_id: LCC-01-03
title: "Cara Memverifikasi Komposisi Alloy pada Produk Logam"
slug: "verifikasi-alloy-produk-logam"
...
date_modified: null
parent_topic: LCC-01
primary_intent: "Meminta bukti komposisi bahan"
reader_community: "Cubicle.co.id"
reader_address: "Teman Cubicle.co.id"
final_route: "/artikel/verifikasi-alloy-produk-logam.html"
...
# Cara Memverifikasi Komposisi Alloy pada Produk Logam

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cara Memverifikasi Komposisi Alloy pada Produk Logam”
...
- **Primary intent:** Meminta bukti komposisi bahan
...
- **Scope boundary:** Fokus evidence, bukan menebak grade dari warna.
- **Final public route:** `/artikel/verifikasi-alloy-produk-logam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara Memverifikasi Komposisi Alloy pada Produk Logam**.
...
- **Tie back to this article:** Keep the explanation specific to “Cara Memverifikasi Komposisi Alloy pada Produk Logam”.
