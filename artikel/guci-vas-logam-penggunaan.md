---
article_id: LCC-07-05
title: "Guci dan Vas Logam untuk Bunga Kering atau Air"
slug: "guci-vas-logam-penggunaan"
...
date_modified: null
parent_topic: LCC-07
primary_intent: "Menentukan penggunaan wadah"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/guci-vas-logam-penggunaan.html"
...
# Guci dan Vas Logam untuk Bunga Kering atau Air

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Guci dan Vas Logam untuk Bunga Kering atau Air”
...
- **Primary intent:** Menentukan penggunaan wadah
...
- **Scope boundary:** Fokus risiko air/kedap; bukan jaminan watertight tanpa uji.
- **Final public route:** `/artikel/guci-vas-logam-penggunaan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Guci dan Vas Logam untuk Bunga Kering atau Air**.
...
- `/guci/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Guci dan Vas Logam untuk Bunga Kering atau Air”.
