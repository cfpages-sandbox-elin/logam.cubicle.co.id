---
article_id: LCC-10-03
title: "Gambar Kerja dan Shop Drawing untuk Kerajinan Logam"
slug: "shop-drawing-kerajinan-logam"
description: "Turn dimensions, motif, reference, function, finish, and site constraints into a fabrication brief"
status: outline
publication_date: "2026-04-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: LCC-10
primary_intent: "Menentukan dokumen produksi"
reader_community: "Cubicle.co.id"
reader_address: "Kawan Cubicle.co.id"
final_route: "/artikel/shop-drawing-kerajinan-logam.html"
...
# Gambar Kerja dan Shop Drawing untuk Kerajinan Logam

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Gambar Kerja dan Shop Drawing untuk Kerajinan Logam”
- **Reader and situation:** Turn dimensions, motif, reference, function, finish, and site constraints into a fabrication brief
- **Reader outcome:** Turn dimensions, motif, reference, function, finish, and site constraints into a fabrication brief
- **Primary intent:** Menentukan dokumen produksi
...
- **Scope boundary:** Fokus drawing/approval; teknik fabrikasi dimiliki LCC-02.
- **Final public route:** `/artikel/shop-drawing-kerajinan-logam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Gambar Kerja dan Shop Drawing untuk Kerajinan Logam**.
...
- `LCC-10-01` → `/artikel/checklist-brief-logam-custom.html` — Checklist Brief Kerajinan Logam Custom
- `LCC-10-02` → `/artikel/dimensi-toleransi-produk-logam.html` — Dimensi, Toleransi, dan Titik Interface pada Produk Custom
- `LCC-10-04` → `/artikel/referensi-motif-produk-custom.html` — Mengirim Referensi Motif tanpa Melanggar Hak Pihak Lain
- `LCC-10-05` → `/artikel/mockup-sampel-kerajinan-logam.html` — Mockup dan Sampel sebelum Produksi Penuh
...
- **Tie back to this article:** Keep the explanation specific to “Gambar Kerja dan Shop Drawing untuk Kerajinan Logam”.
