---
article_id: LCC-01-05
title: "Tembaga atau Kuningan untuk Area Indoor dan Outdoor"
slug: "logam-indoor-vs-outdoor"
description: "Understand materials, terminology, appearance, properties, and appropriate uses"
status: outline
publication_date: "2025-09-12"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: LCC-01
primary_intent: "Memilih bahan menurut exposure"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/logam-indoor-vs-outdoor.html"
...
# Tembaga atau Kuningan untuk Area Indoor dan Outdoor

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tembaga atau Kuningan untuk Area Indoor dan Outdoor”
- **Reader and situation:** Understand materials, terminology, appearance, properties, and appropriate uses
- **Reader outcome:** Understand materials, terminology, appearance, properties, and appropriate uses
- **Primary intent:** Memilih bahan menurut exposure
...
- **Scope boundary:** Fokus lingkungan penggunaan; coating/patina dimiliki LCC-03.
- **Final public route:** `/artikel/logam-indoor-vs-outdoor.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tembaga atau Kuningan untuk Area Indoor dan Outdoor**.
...
- **Original sources:** [ISO 3834-1 fusion-welding quality requirements](https://www.iso.org/standard/81650.html), [ISO 9606-1 welder qualification](https://www.iso.org/standard/54936.html), [SNI 1729:2020 — BSN](https://pesta.bsn.go.id/produk/detail/12625-sni17292020).
- **Purpose for this article:** Ground fabrication and QC without DIY structural welding instructions.
- **Safe grounded facts:** A smooth bead, welder card, WPS, or NDT report proves only its own scope; structural adequacy belongs to the designed and accepted joint/system.
- **Limits:** Require current design code, drawings, material traceability, qualified procedure/personnel, inspection plan/acceptance, deviations/repairs, and engineer approval.
...
- `LCC-01-03` → `/artikel/verifikasi-alloy-produk-logam.html` — Cara Memverifikasi Komposisi Alloy pada Produk Logam
- `LCC-01-04` → `/artikel/ketebalan-dan-konstruksi-logam.html` — Lembaran Tebal, Tipis, dan Hollow: Pertanyaan Pemilihan
- `LCC-01-06` → `/artikel/kompatibilitas-logam-tembaga-kuningan.html` — Interaksi Tembaga atau Kuningan dengan Logam Lain
...
- **Tie back to this article:** Keep the explanation specific to “Tembaga atau Kuningan untuk Area Indoor dan Outdoor”.
