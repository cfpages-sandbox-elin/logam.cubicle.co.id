---
article_id: LCC-02-05
title: "Sambungan Las, Brazing, Solder, dan Mekanis"
slug: "jenis-sambungan-kerajinan-logam"
...
date_modified: null
parent_topic: LCC-02
primary_intent: "Memahami opsi penyambungan"
reader_community: "Cubicle.co.id"
reader_address: "Teman Cubicle.co.id"
final_route: "/artikel/jenis-sambungan-kerajinan-logam.html"
...
# Sambungan Las, Brazing, Solder, dan Mekanis

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sambungan Las, Brazing, Solder, dan Mekanis”
...
- **Primary intent:** Memahami opsi penyambungan
...
- **Scope boundary:** Fokus prinsip; metode final harus sesuai fungsi dan review ahli.
- **Final public route:** `/artikel/jenis-sambungan-kerajinan-logam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sambungan Las, Brazing, Solder, dan Mekanis**.
...
- `LCC-02-03` → `/artikel/casting-vs-lembaran-logam.html` — Casting vs Kerajinan dari Lembaran
- `LCC-02-04` → `/artikel/repousse-chasing-embossing-logam.html` — Repousse, Chasing, dan Embossing pada Relief Logam
- `LCC-02-06` → `/artikel/menilai-workmanship-kerajinan-logam.html` — Bukti Workmanship yang Perlu Dilihat pada Sampel
...
- **Tie back to this article:** Keep the explanation specific to “Sambungan Las, Brazing, Solder, dan Mekanis”.
