---
article_id: LCC-09-04
title: "Air Mancur Logam: Antarmuka Wadah, Pompa, dan Finishing"
slug: "air-mancur-logam"
...
date_modified: null
parent_topic: LCC-09
primary_intent: "Mengkoordinasikan komponen fountain"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/air-mancur-logam.html"
...
# Air Mancur Logam: Antarmuka Wadah, Pompa, dan Finishing

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Air Mancur Logam: Antarmuka Wadah, Pompa, dan Finishing”
...
- **Primary intent:** Mengkoordinasikan komponen fountain
...
- **Scope boundary:** Fokus interface; plumbing/listrik final di luar editorial scope.
- **Final public route:** `/artikel/air-mancur-logam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Air Mancur Logam: Antarmuka Wadah, Pompa, dan Finishing**.
...
- `/water-fountain/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Air Mancur Logam: Antarmuka Wadah, Pompa, dan Finishing”.
